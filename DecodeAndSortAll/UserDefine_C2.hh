...
#define ROOTFILEPATH "/home/zhy/Desktop/sort/C2_Decode/"  //The path to generate the ROOT file
...
//#define Crate0RAWFILEPATH "/media/zhy/exp/ge_data/"   //Path to the original binary
...
#define Crate1RAWFILEPATH "/home/zhy/Desktop/sort/CsI_ExpData/"   //Path to the original binary
// #define Crate1RAWFILEPATH "/media/zhy/exp/csi_data/"   //Path to the original binary
#define Crate1RAWFILENAME "data"                   //The file name of the original file
#define Crate1num 9   //Number of modules used in this crate
const unsigned short Crate1SamplingRate[Crate1num] = {100,100,100,100,100,100,100,250,250};//Specify the sampling rate of each modules separately; 100/250/500 sampling rates; 0 to skip the module
const unsigned short Crate1Revision[Crate1num] = {15,15,15,15,15,15,15,15,15};
