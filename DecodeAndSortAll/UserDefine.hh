...
#define Crate0RAWFILEPATH "/home/zhy/Desktop/sort/CsI_ExpData/"   //Path to the original binary
// #define Crate0RAWFILEPATH "/media/zhy/exp/csi_data/"   //Path to the original binary
#define Crate0RAWFILENAME "data"                   //The file name of the original file
#define Crate0num 9   //Number of modules used in this crate
const unsigned short Crate0SamplingRate[Crate0num] = {100,100,100,100,100,100,100,250,250};//Specify the sampling rate of each modules separately; 100/250/500 sampling rates; 0 to skip the module
const unsigned short Crate0Revision[Crate0num] = {15,15,15,15,15,15,15,15,15};
