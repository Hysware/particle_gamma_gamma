...
#define ROOTFILEPATH "/home/zhy/Desktop/sort/CsI_Decode/"  //The path to generate the ROOT file
...
const unsigned short Crate0SamplingRate[Crate0num] = {100,100,100,100,100,100,250,250};//Specify the sampling rate of each modules separately; 100/250/500 sampling rates; 0 to skip the module
const unsigned short Crate0Revision[Crate0num] = {15,15,15,15,15,15,15,15};//RevD=13, RevF=15, RevH=17
